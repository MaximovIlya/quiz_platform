...
RETURNING id, email, password, name, role, google_id, created_at
`
...
SELECT id, email, password, name, role, google_id, created_at FROM users WHERE email = $1
`
...
SELECT id, email, password, name, role, google_id, created_at FROM users WHERE google_id = $1
`
...
SELECT id, email, password, name, role, google_id, created_at FROM users WHERE id = $1
`
...
UPDATE users SET google_id = $2 WHERE id = $1 RETURNING id, email, password, name, role, google_id, created_at
`
